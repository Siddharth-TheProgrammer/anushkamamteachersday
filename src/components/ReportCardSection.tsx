...
export function ReportCardSection() {
  ...
  const submit = useMutation({
    ...
    onError: () =>
      toast.error("Something went wrong while saving your report. Please try again."),
  });
    ...
    <section id="report-card" className="mx-auto w-full max-w-3xl px-5 py-20">
      <Reveal>
        ...
        <p className="mx-auto mt-4 max-w-xl text-center text-muted-foreground">
          Ma'am, this part of the page belongs to you. Please rate your student, Siddharth
          Yadav, honestly — every star starts empty.
        </p>
      </Reveal>
      ...
      <AlertDialog open={confirmDelete} onOpenChange={setConfirmDelete}>
        <AlertDialogContent className="rounded-3xl">
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              This removes the saved report card only. Your complaints will stay exactly where
              they are.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
